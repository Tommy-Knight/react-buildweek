...
const Learning = () => {
  return (
    <Card id="Learning" style={{}} className="my-4 ">
      <ListGroup variant="flush">
        ...
        <Row>
          <Col className="col-12">
            <ListGroup.Item className="text-justiyfy">
              Add new skills with thease courses, free for 24 hours
            </ListGroup.Item>
          </Col>
        ...
        <Row>
          ...
          <Col>
            <ListGroup.Item>Learning Canva in Covid-19 pandemic</ListGroup.Item>
          </Col>
        </Row>
        <Row>
          <Col className="col-4 ">
